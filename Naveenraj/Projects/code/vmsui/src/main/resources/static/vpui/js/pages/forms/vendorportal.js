	...
	var basicFileDomainTypeMap = new Object();
	var complianceFileDomainTypeMap = new Object();
	var legalFileDomainTypeMap = new Object();
	var bankFileDomainTypeMap = new Object();
	...
	function reloadCustWindow(){
		
		location.reload(true);
		return true;
	}

	$("#vmsDashBoardButton").click(function(){
		//var url = 'http://localhost/vm';
		var url = '../../../vmslogin.html';
		window.location.href = url;
	});
	
	function setBasicSectionDocDetails(input, domainType) {
		var fileName = input.files[0].name;
		console.log("domainType"+domainType);
		basicFileDomainTypeMap[domainType]=fileName;
                       
    }
	
	function setComplianceSectionDocDetails(input, domainType) {
		var fileName = input.files[0].name;
		console.log("domainType"+domainType);
		complianceFileDomainTypeMap[domainType]=fileName;
                       
    }
	
	function setLegalSectionDocDetails(input, domainType) {
		var fileName = input.files[0].name;
		console.log("domainType"+domainType);
		legalFileDomainTypeMap[domainType]=fileName;
                       
    }
	
	function setBankSectionDocDetails(input, domainType) {
		var fileName = input.files[0].name;
		console.log("domainType"+domainType);
		bankFileDomainTypeMap[domainType]=fileName;
    ...
    function saveVendorBasicData(){
        ...
        var mobileNumber = $('#mobileNumber').val();
				...
				var vendorCompanyData = {
					...
					"address":address,
                    "fileNameDomainTypeMap":basicFileDomainTypeMap,
					"vendor":vendor
				};
                ...
                //alert('restVendorRegBasicDataUrl............:'+restVendorRegBasicDataUrl);
                console.log("requestdata..:"+data);
               // restVendorRegBasicDataUrl = "http://localhost:8081/vendorcompanyonly";
				...
				var companyCompliance = 
					{
						...
						"fileNameDomainTypeMap":complianceFileDomainTypeMap,
	...
	function saveVendorLegalData(){
				...
				var companyLegal = 
					{
						...
						"fileNameDomainTypeMap":legalFileDomainTypeMap,
                ...
                console.log(restVendorRegLegalDataUrl);
                $.ajax({
	...
	function getSavedDocsForDownload(){
                ...
                var  restDocsDownloadUrl = "http://localhost:8081/doclist/"+taxId;
				...
				var bankAccountData = 
					{
						...
						"fileNameDomainTypeMap":bankFileDomainTypeMap
					};
            ...
            var populateHelpers =
				{
                    ...
                    populateField: function(data)
					{
                        ...
                        if(data['bankAccount'][0].routingNumber == 0){
                        	data['bankAccount'][0].routingNumber = "";
                        }
                        if(data['bankAccount'][0].accountNumber == 0){
                        	data['bankAccount'][0].accountNumber = "";
                        }
